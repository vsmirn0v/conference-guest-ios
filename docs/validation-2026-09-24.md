...
Build 6 was uploaded successfully and is processing in App Store Connect. It has not been added to the public beta group; build 5 remains the approved public beta while build 6 is checked internally.
